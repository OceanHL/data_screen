  ...
  <div class="com-container">
    <div class="title" :style="comStyle">
      ...
      <div class="select-con" v-show="showChoice" :style="marginStyle">
        <div v-for="item in selectTypes" :key="item.key" @click="handleSelect(item.key)">
          {{ item.text }}
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    selectTypes() {
      ...
      else return this.allData.type.filter(item => item.key !== this.choiceType);
    },
    showTitle() {
      if (!this.allData) return "";
      else return this.allData[this.choiceType].title;
    },
    comStyle() {
      return {
